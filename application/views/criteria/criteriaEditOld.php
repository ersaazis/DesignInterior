            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url('criteria/editCriteria') ?>" method="post" id="editCriteria" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
...
<script src="<?php echo base_url(); ?>assets/js/editCriteria.js" type="text/javascript"></script>